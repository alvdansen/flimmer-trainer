"""Tests for flimmer.caption.prompts — pure Python, no API calls.
...
class TestCustomPrompt:
    ...
    def test_custom_prompt_overrides_in_captioner(self) -> None:
        ...
        from flimmer.caption.captioner import caption_clips
        from flimmer.caption.models import CaptionConfig
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            import flimmer.caption.captioner as cap_mod
