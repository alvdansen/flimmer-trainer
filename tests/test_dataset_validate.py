"""Tests for flimmer.dataset.validate — core validation engine.
...
from flimmer.dataset.discover import discover_dataset
...
class TestValidateDataset:
    ...
    def test_flimmer_structure(self, tmp_path: Path):
