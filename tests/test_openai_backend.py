"""Tests for flimmer.caption.openai_compat — OpenAI-compatible backend.
...
from flimmer.caption.openai_compat import OpenAICompatBackend
...
class TestCaptionVideo:
    ...
    def test_extracts_and_captions(self, monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
        ...
        monkeypatch.setattr(
            "flimmer.caption.openai_compat.extract_frames",
        ...
        monkeypatch.setattr("flimmer.caption.openai_compat.shutil.rmtree", lambda *a, **kw: None)
    ...
    def test_cleanup_on_error(self, monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
        ...
        cleanup_calls = []
        monkeypatch.setattr(
            "flimmer.caption.openai_compat.shutil.rmtree",
...
class TestOpenAIFactory:
    ...
    def test_create_openai_backend(self) -> None:
        ...
        from flimmer.caption.captioner import _create_backend
