"""Flimmer dataset validation data models.
...
These operate at a higher level than flimmer.video.models — they describe
...
class StructureType(str, Enum):
    ...
    - flimmer: organized into training/targets/ and training/signals/ subfolders.
      Example: training/targets/clip_001.mp4, training/signals/captions/clip_001.txt
      This is the Flimmer convention that teaches users about target/signal separation.
    """
    FLAT = "flat"
    FLIMMER = "flimmer"
...
class DatasetValidation(BaseModel):
    ...
    """Detected directory layout (flat or flimmer)."""
