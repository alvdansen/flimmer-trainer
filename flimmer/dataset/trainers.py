...
def generate_trainer_config(
    ...
    Args:
        ...
        config: The flimmer data config.
...
def generate_musubi_config(
    ...
    lines = [
        ...
        f"# Generated by: python -m flimmer.dataset organize <source> -o {_to_forward_slash(output_dir)} -t musubi",
        "",
...
def generate_aitoolkit_config(
    ...
    lines = [
        ...
        f"# Generated by: python -m flimmer.dataset organize <source> -o {_to_forward_slash(output_dir)} -t aitoolkit",
        "",
        "# ─── HOW TO USE THIS FILE ───",
