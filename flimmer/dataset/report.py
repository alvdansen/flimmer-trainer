...
from flimmer.dataset.bucketing import BucketingResult
from flimmer.dataset.models import DatasetReport, OrganizeResult
...
def _print_rich_issue(console: object, issue: object, indent: int = 2) -> None:
    ...
    from flimmer.video.models import Severity as Sev
    prefix = " " * indent
    color = {
        Sev.ERROR: "red",
        Sev.WARNING: "yellow",
