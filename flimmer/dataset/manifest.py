...
The manifest (flimmer_manifest.json) is a lightweight summary of a validated
...
from flimmer.dataset.models import DatasetReport, DatasetValidation, SamplePair
...
def build_manifest(report: DatasetReport, config: FlimmerDataConfig) -> dict:
