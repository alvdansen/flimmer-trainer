...
Usage:
    from flimmer.triage import triage_clips
...
from flimmer.triage.embeddings import CLIPEmbedder, check_clip_available
from flimmer.triage.filters import build_prompt_cache, detect_text_overlays
...
from flimmer.triage.sampler import (
    _get_duration,
    cleanup_frames,
    sample_clip_frames,
    sample_scene_frames,
)
from flimmer.triage.concepts import discover_concepts, print_concept_summary
...
def _write_scene_manifest(report: VideoTriageReport, output_path: Path) -> None:
    ...
    print(f"  python -m flimmer.video ingest <video_dir> -o <output_dir> "
