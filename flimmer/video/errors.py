...
class FlimmerVideoError(Exception):
...
class FFmpegNotFoundError(FlimmerVideoError):
...
class SceneDetectNotFoundError(FlimmerVideoError):
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            "Install it with: pip install 'flimmer[video]' "
            "or: pip install scenedetect[opencv]"
        )


class ProbeError(FlimmerVideoError):
...
class SplitError(FlimmerVideoError):
...
class ExtractionError(FlimmerVideoError):
