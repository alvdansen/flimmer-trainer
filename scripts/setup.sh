...
echo "  examples/full_train.yaml      Full T2V training config (Wan 2.2)"
echo "  examples/i2v_wan21.yaml       I2V training config (Wan 2.1)"
echo "  examples/i2v_wan22.yaml       I2V training config (Wan 2.2 MoE)"
echo "  examples/project_moe.yaml     Multi-phase project workflow"
echo ""
