...
See `examples/project_moe.yaml` for the canonical example.

**Basic commands:**

```bash
# Run the next pending phase
bash scripts/train.sh --project examples/project_moe.yaml

# Run all pending phases sequentially
bash scripts/train.sh --project examples/project_moe.yaml --all

# Check which phases are completed/pending
bash scripts/train.sh --project examples/project_moe.yaml --status

# Preview what would happen
bash scripts/train.sh --project examples/project_moe.yaml --dry-run
```
